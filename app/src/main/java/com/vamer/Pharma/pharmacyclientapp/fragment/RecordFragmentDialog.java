 ...
 * Use the {@link RecordFragmentDialog#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RecordFragmentDialog extends DialogFragment {
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_POSITION = "position";
    private static final String LOG_TAG = RecordFragmentDialog.class.getSimpleName();
    ...
    public static RecordFragmentDialog newInstance(int position) {
        RecordFragmentDialog f = new RecordFragmentDialog();
        Bundle b = new Bundle();
