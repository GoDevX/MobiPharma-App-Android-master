package com.vamer.Pharma.soundrecorder;
...
import com.vamer.Pharma.soundrecorder.activities.MainActivity;
    ...
    public void setFileNameAndPath(){
        ...
        do{
            ...
            mFileName = getString(R.string.default_file_name)
                    + "_" + (/*mDatabase.getCount()*/ CenterRepository.getCenterRepository()
                    .getListOfProductsInShoppingList().size() + count) + ".mp3";
