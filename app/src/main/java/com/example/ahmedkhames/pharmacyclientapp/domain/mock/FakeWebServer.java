...
package com.example.ahmedkhames.pharmacyclientapp.domain.mock;
    ...
    public void getAllElectronics() {
        ...
        productlist
                .add(new Product(
                        ...
                        "Antipyretics (/ænti.paɪˈrɛ.tɪks/, from anti- 'against' and pyretic 'feverish') are substances that reduce fever..",
                        "5490",
                        "10",
                        "4290",
                        "0",
